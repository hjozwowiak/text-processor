...
const ContainerModifiersToRemove = ({
    toRemoveStartEnd,
        ...
        <div className="container--section container-directionColumn">
            <TextArea
                targetClasses={[
                    ...
                    "container-borderRoundTopLeftMedium",
                    "container-borderRoundTopRightMedium"
                ]}
            ...
            <TextArea
                targetClasses={[
                    "input--textarea-medium",
                    "container-borderRoundBottomLeftMedium",
                    "container-borderRoundBottomRightMedium"
                ]}
