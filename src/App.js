    ...
    render() {
        ...
        const runMod = () => {
            ...
            for (let i = 0; i < phrasesArray.length; i++) {
                ...
                const toRemoveStartRegex = new RegExp(
                    "^" + toRemoveStartEnd,
                    "gi"
                );
                const toRemoveEndRegex = new RegExp(
                    toRemoveStartEnd + "$",
                    "gi"
                );
            ...
            <div className="container--app">
                <div className="container-directionColumn container--app-content">
                    ...
                    <ContainerModifiers
                        ...
                        updateToAddStart={toAddStart =>
                            this.setState({ toAddStart })
                        }
                        toAddEnd={toAddEnd}
                        ...
                        updateLetterCase={letterCase =>
                            this.setState({ letterCase })
                        }
                    />
